<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="doctor_home.php">Doctor Dashboard</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            if (isset($_SESSION["user_id"]) && !empty($_SESSION["user_id"])) {
                echo '<li class="nav-item"><a class="nav-link" href="doctor_home.php">Home</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="update_profile.php">Update Profile</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="appointments.php">My Appointments</a></li>';
