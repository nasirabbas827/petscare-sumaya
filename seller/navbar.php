    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            if (isset($_SESSION["user_id"]) && !empty($_SESSION["user_id"])) {
                echo '<li class="nav-item"><a class="nav-link" href="seller_home.php">Home</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="update_profile.php">Update Profile</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="view_pets.php">View Pets</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="view_orders.php">View Orders</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="doctors.php">Consult Doctor</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="appointment_status.php">Appointment Status</a></li>';
