...
<div class="container mt-4 mb-5">
    ...
    <div class="card">
        <div class="card-body">
            <p class="card-text"><strong>Doctor Name:</strong> <?php echo $doctor['username']; ?></p>
            <p class="card-text"><strong>Email:</strong> <?php echo $doctor['email']; ?></p>
            <p class="card-text"><strong>Phone:</strong> <?php echo $doctor['phone']; ?></p>
            <p class="card-text"><strong>City:</strong> <?php echo $doctor['city']; ?></p>
            <p class="card-text"><strong>Address:</strong> <?php echo $doctor['address']; ?></p>
        </div>
    </div>
